  ...
  return `
      <div id=${id}>
          ${
            ...
            // --------------- This is for [if we have image it will display or else no it will display default image ] ----------
            url ?
            `<img width="100%" src=${url} class="img-fluid place__holder__image mb-3" alt="Card Image">`
...
const EditTask = (e) => {
    ...
    editImage = parentNode.childNodes[3].childNodes[1];
    ...
    console.log(editImage , taskTitle , taskDescription , taskType , SubmitButton);
}